...
const Home = () => {
  return (
    <main className="flex flex-col-reverse justify-center gap-10 lg:flex-row">
      <div className="flex w-full lg:w-1/2 gap-4 px-6 py-3 logos intro">
        <div>
      ...
      <div className="flex flex-col justify-center gap-6 w-full lg:w-1/2 p-5">
        <div className="rounded-2xl">
          <h1 className="md:text-4xl text-center text-amber-400 uppercase text-xl font-extrabold  font-mono title">
            Descubre que partido votar segun sus{" "}
            <span className="font-extrabold text-black">propuestas</span>
          </h1>
          <p className="text-center text-indigo-800 font-bold my-4 text-xl md:text-4xl">
        ...
        <Link
          className="md:px-8 md:py-6 w-fit px-4 py-3 self-center border bg-yellow-500 hover:bg-yellow-600 rounded-xl  text-white  uppercase font-bold"
          to={"/comenzar"}
        >
          iniciar
        </Link>
